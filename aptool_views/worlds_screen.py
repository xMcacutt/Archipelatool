...
def worlds_screen(page: ft.Page):
    page.theme = ft.Theme(
        ...
        radio_theme=ft.RadioTheme(fill_color=AppColors.green),
    ...
    game_data = {}
    try:
        with open("assets/my_worlds.json", "r", encoding="utf-8-sig") as f:
    ...
    def create_game_card(name, details):
        return ft.Card(
            ...
            content=ft.Container(
                ...
                content=ft.ListTile(
                    title=ft.Text(name, size=20, color=AppColors.green),
                        ...
                        ft.Container(
                            ft.Row(
                                [
                                    ...
                                    ft.Text(f"Version: {details.get('Version', 'Unknown')}", color=AppColors.mainText, size=12),
                                ],
                            ),
                        )],
                        expand=True
                    ),
                    leading=ft.IconButton(icon=ft.Icons.UPDATE_ROUNDED),
    ...
    def refresh_list():
        ...
        list_view.controls = filtered if filtered else [ft.Text("No worlds found", color="red")]
        page.update()
